var gitblog = function(config) {
    ...
    var Footer = function() {
        ...
        this.icons = [];
        this.icon_num = 0;
        this.content = 'Powered by <a href="https://space.bilibili.com/3493132937202075?spm_id_from=333.1007.0.0" target="_blank" style="color: aquamarine;text-decoration:none;border-bottom: 1px solid #79f8d4;">Albert</a>';
    }
